...
if(isset($_POST['btnAddTodo'])){
    ...
    if(empty($title)){
      ...
      $userEmail =   $_SESSION['email'] ;
        $query = "insert into todo(title,task,created_by)values('$title','$task','$userEmail')";
        $query_run = mysqli_query($connection,$query);
        
        if($query_run){
            $msg = "<div class='font-medium text-lime-600 hover:text-lime-500 text-center'>Task added</div>";
            $_POST['title'] = '';
            $_POST['task'] = '';
          ...
          <div class="flex-1 p-3 md:py-[35]">
            <div class="space-y-2 md:space-y-6">
              <div class="card card-side bg-base-200 shadow-xl">
                ...
                <div class="card-body">
                  <h2 class=" text-center text-black font-bold text-3xl">Add Todo</h2>
                  <?php echo $msg; ?>
                ...
                <div class="mt-6">
                    <form action="" method="POST" class="space-y-6">
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="title" name="title" type="title" autocomplete="title" value="<?php echo $_POST['title'] ?>"  placeholder="Todo Title" class="block w-full px-5 py-3 text-base text-white placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-slate-500 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300">
                            </div>
                        </div>

                        <div class="space-y-1">
                            <label for="task" class="block text-sm font-medium text-neutral-600"> Task </label>
                            <div class="mt-1">
                                <textarea name="task" id="task" cols="30" rows="10"  placeholder="type in your todo task" class="block w-full px-5 py-3 text-base text-white placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-slate-500 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300"><?php echo $_POST['task'] ?></textarea>
                            </div>
                        </div>


                        <div>
                            <button type="submit" name="btnAddTodo" class="flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-black rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Sign in</button>
                        </div>
                    </form>
